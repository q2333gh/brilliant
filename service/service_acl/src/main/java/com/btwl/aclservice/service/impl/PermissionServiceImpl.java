...
import com.btwl.aclservice.helper.MemuHelper;
import com.btwl.aclservice.helper.PermissionHelper;
import com.btwl.aclservice.mapper.PermissionMapper;
...
public class PermissionServiceImpl extends ServiceImpl<PermissionMapper, Permission> implements
  ...
  //获取全部菜单
  @Override
  public List<Permission> queryAllMenubrilliant() {
    //1 查询菜单表所有数据
    QueryWrapper<Permission> wrapper = new QueryWrapper<>();
    wrapper.orderByDesc("id");
    List<Permission> permissionList = baseMapper.selectList(wrapper);
  ...
  //============递归删除菜单==================================
  @Override
  public void removeChildByIdbrilliant(String id) {
  ...
  //=========================给角色分配菜单=======================
  @Override
  public void saveRolePermissionRealtionShipbrilliant(String roleId, String[] permissionIds) {
    //roleId角色id
