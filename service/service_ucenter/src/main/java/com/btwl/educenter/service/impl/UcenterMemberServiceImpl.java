package com.btwl.educenter.service.impl;
...
import com.btwl.educenter.mapper.UcenterMemberMapper;
 ...
 */
@Service
public class UcenterMemberServiceImpl extends
    ServiceImpl<UcenterMemberMapper, UcenterMember> implements UcenterMemberService {
  ...
  public void register(RegisterVo registerVo) {
    ...
    if (StringUtils.isEmpty(mobile) || StringUtils.isEmpty(password)
      ...
      throw new BrilliantCustomException(20001, "注册失败");
    }
    //判断验证码
    //获取redis验证码
