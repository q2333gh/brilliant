...
import com.btwl.eduservice.mapper.EduCourseMapper;
...
public class EduCourseServiceImpl extends ServiceImpl<EduCourseMapper, EduCourse> implements
  ...
  public String saveCourseInfo(CourseInfoVo courseInfoVo) {
    ...
    if (insert == 0) {
      //添加失败
      throw new BrilliantCustomException(20001, "添加课程信息失败");
    }
  ...
  public void updateCourseInfo(CourseInfoVo courseInfoVo) {
    ...
    if (update == 0) {
      throw new BrilliantCustomException(20001, "修改课程信息失败");
    }
  ...
  public void removeCourse(String courseId) {
    ...
    if (result == 0) { //失败返回
      throw new BrilliantCustomException(20001, "删除失败");
    }
  }

  //1 条件查询带分页查询课程
  @Override
  public Map<String, Object> getCourseFrontList(Page<EduCourse> pageParam,
